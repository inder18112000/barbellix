...
export const styles = StyleSheet.create({
  ...
  shimmerOverlay: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: borderRadius.xl },
  decorCircle1: { position: 'absolute', right: -40, top: -40, width: 160, height: 160, borderRadius: 80, backgroundColor: 'rgba(255,255,255,0.08)' },
  decorCircle2: { position: 'absolute', right: 20, bottom: -60, width: 120, height: 120, borderRadius: 60, backgroundColor: 'rgba(255,255,255,0.06)' },
  cardTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  cardBrand: { ...typography.h3, color: '#fff' },
  cardBrandSub: { ...typography.caption, color: 'rgba(255,255,255,0.7)', marginTop: 2 },
  streakPill: { paddingHorizontal: spacing.sm, paddingVertical: 4, borderRadius: borderRadius.full },
  streakPillText: { ...typography.label, color: '#fff' },
  cardBottom: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  cardName: { ...typography.h4, color: '#fff' },
  cardId: { ...typography.caption, color: 'rgba(255,255,255,0.6)', marginTop: 2, letterSpacing: 2 },
  cardFlipHint: { ...typography.caption, color: 'rgba(255,255,255,0.5)', fontStyle: 'italic' },
